        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Usercommented = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_comments_places_place_id",
                        column: x => x.place_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_fav_doc", x => x.id);
                    table.ForeignKey(
                        name: "FK_fav_doc_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_fav_doc_places_place_id",
                        column: x => x.place_id,
                        principalTable: "places",
                        principalColumn: "place_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    expired_date = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_offers", x => x.id);
                    table.ForeignKey(
                        name: "FK_offers_places_place_id",
                        column: x => x.place_id,
                        principalTable: "places",
                        principalColumn: "place_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    like_dis = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_comment_like", x => x.id);
                    table.ForeignKey(
                        name: "FK_comment_like_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_comments_place_id",
                table: "comments",
                column: "place_id");

            migrationBuilder.CreateIndex(
                name: "IX_fav_doc_ClientId",
                table: "fav_doc",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_fav_doc_place_id",
                table: "fav_doc",
                column: "place_id");

            migrationBuilder.CreateIndex(
                name: "IX_offers_place_id",
                table: "offers",
                column: "place_id");
